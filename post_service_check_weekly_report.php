...
if ($response['status'] === 'success') {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if($action_1 !=''){
            $smoke_alarm_tested_and_working = json_encode(['smoke_alarm_tested_and_working'=>$smoke_alarm_tested_and_working, 'action_1'=>$action_1]);
        }elseif($action_2 !=''){
        ...
        $response = $user->post_service_check_weekly_report(
